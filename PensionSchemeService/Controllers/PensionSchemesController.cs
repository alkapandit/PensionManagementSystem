...
namespace PensionSchemeService.Controllers
{
...
*/
    ...
    {
        private readonly PensionSchemeServiceContext _context;

        public PensionSchemesController(PensionSchemeServiceContext context)
        {
            _context = context;
        }
